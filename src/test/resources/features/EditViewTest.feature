Feature: Edit View
  ...
  Scenario Outline: Successfully Edit Column View
    ...
    |testViewEdited|newviewedited|Source|Includes|sarah db|"sarah db"|Analysis Type,Blanks %,Column,Column Description,Column Group,Column Name,Column Type,Count Blanks,Count All,Count Distinct,Data Type,Source|